...
def generate_statement_classification_map(lang='python'):
    with open('./statement_attention', 'r') as f:
        item = 'blank_item'
        while True:
            item = f.readline()
            key = item.split('  ||  ')[0]
        ...
        if lang == 'python':
            python_statement_classification_map[key] = value
        elif lang == 'java':
            java_statement_classification_map[key] = value
...
class Code_Reduction():  # self.statement_attention: statement categories' attention. Form as:
    ...
    def __init__(self, code, lang='java', targetLength=120, **kwargs):
        self.code = code
        self.lang = lang
    ...
    def generate_statements(self):
        ...
        if self.lang == 'python':
            ...
            self.statements = []
            for statement in statements:
                if len(python_statement_classification_map) == 0:
                    generate_statement_classification_map(lang='python')
            ...
            self.statements = []
            for statement in statements:
                if len(java_statement_classification_map) == 0:
                    generate_statement_classification_map(lang='java')
